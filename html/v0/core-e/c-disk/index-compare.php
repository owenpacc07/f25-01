                    ...
                    <div class="card-body">
                        ...
                        <form method="post" class="text-center">
                            ...
                            <button type="button" class="btn btn-purple d-inline mr-2" onclick="showChart(event)">Show
                                Chart</button>
                            <button type="button" class="btn btn-purple d-inline" onclick="saveResults()">Save
                                result</button>
                        </form>
                        ...
                        <div class="form-group">
                            <label for="expectedOutput">Output Data:</label>
                            <textarea id="expectedOutput" class="form-control" rows="6"
                                readonly><?php echo htmlspecialchars($output); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
