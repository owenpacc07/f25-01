...
//$coreCPath = "/var/www/projects/s25-01/html/files/core-c/c-memory";
$coreCPath = realpath(__DIR__ . '/../../../files/core-c/c-memory/');
...
<body>
    ...
    function writeInput($processes, $memoryslots) {
        ...
        $file = fopen("../../../files/core-c/c-memory/in-memory.dat", "w");
        ...
        $flag = fopen("../../../files/core-c/c-memory/flag-file.txt", "w");
        fwrite($flag, "1");
        fclose($flag);
    }
