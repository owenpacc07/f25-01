...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: ./core-a/m-" . $mechanismid);
}
...
<body>
  ...
  <div class="container">
            ...
            <form id="midForm" method="post" enctype="multipart/form-data" action="">
              <div class="input-group">
                ...
                <div class="input-group-append">
                  <input id="formBtn" class="btn btn-dark" type="submit" style="background-color:#4B0082;" value="Search">
                </div>
              </div>
            </form>
          </div>
	...
	<a href="core-c/c-cpu/index.php" class="col-md-4 btn btn-outline-secondary" style="color:black;background-color: #B8DB8A;">
          <div class=" padding">
	...
	<a href="core-c/c-page/index.php" class="col-md-4 btn btn-outline-secondary" style="color:black;background-color: #D2BFEF;">
          <div class=" padding">
            <h5 class="text-center">COMPARE</h5>
          </div>
        </a>
	...
	<a href="core-c/c-disk/index.php" class="col-md-4 btn btn-outline-secondary" style="color:black;background-color: #FFE880;">
          <div class=" padding">
            <h5 class="text-center">COMPARE</h5>
          </div>
        </a>
	...
	<a href="core-c/c-memory/index.php" class="col-md-4 btn btn-outline-secondary" style="color:black;background-color: #FF8F00;">
          <div class=" padding">
            <h5 class="text-center">COMPARE</h5>
          </div>
        </a>
	...
	<a href="core-c/c-file/index.php" class="col-md-4 btn btn-outline-secondary" style="color:black;background-color: #DB2F2F;">
          <div class=" padding">
            <h5 class="text-center">COMPARE</h5>
          </div>
        </a>
