...
<body>
    ...
    <?php 
        ...
        include '../navbar.php';
        $output = file_get_contents("/var/www/projects/f22-02/html/files/p5-file-output.txt");
        $input = file_get_contents("/var/www/projects/f22-02/html/files/p5-file-input-continuous.txt");?>
