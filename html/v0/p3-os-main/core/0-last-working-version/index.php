...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //header("Location: https://cs.newpaltz.edu/p/f22-02/v3/p3-os-main/core/index.php?page=" . $target);
    //header("Location: editInputOutput.php");
    header("Location: https://cs.newpaltz.edu/p/f22-02/v3/p3-os-main/core/" . $target);
