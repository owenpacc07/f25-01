...
require_once '../tempfunctions.php'; //creating session files
      ...
      if(isset($_POST['submit'])) {
        ...
        $output_optimal = $_POST['output-optimal'];
       ...
       // do same for output
        ...
        file_put_contents($filename, $output_optimal);
    ...
    $filename = "/var/www/projects/s23-01/html/files/core-a/m-022/out-022.dat";
...
<body>
    ...
    <?php 
        ...
        $format = file_get_contents("../../../files/core-a/m-022/format-022.txt");
        ...
        <div>
            <form action="editLRU.php" method="POST">
                <div class="columns">
                    ...
                    <div class="field column" style="max-width: 500px;">
                        <label for="output-lru">Output Optimal:</label>
