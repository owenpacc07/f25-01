...
<head>
    ...
    <!-- circle style for head, doesn't work in styles.css for some reason. - Ejay -->
    <style>
        .circle {
            width: 200px;
            height: 200px;
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center">
        <h4 id="description">In this scheme, an Index block contains the pointers to all the blocks occupied by the
            file.</h4><br>
    </div>
    ...
    <div id="overlay">
     ...
     <div class="text-center align-items-center justify-content-center secondarycontrols">
