...
function fcfsClick(e) {
    ...
    loadingData(0, first_come_first_serve);
...
function sjfClick(e) {
    ...
    if (preemptive) {
        ...
        loadingData(5, shortest_job_first);
    } else {
        console.log("Non-preemptive SJF");
        updateSchedulerType(1);
        loadingData(1, shortest_job_first);
    }
...
function prioHighClick(e) {
    ...
    if (preemptive) {
        ...
        loadingData(6, priority_high_to_low);
    } else {
        console.log("Non-preemptive Priority High -> Low");
        updateSchedulerType(2);
        loadingData(2, priority_high_to_low);
    }
...
function prioLowClick(e) {
    ...
    if (preemptive) {
        ...
        loadingData(7, priority_low_to_high);
    } else {
        console.log("Non-preemptive Priority Low -> High");
        updateSchedulerType(3);
        loadingData(3, priority_low_to_high);
    }
