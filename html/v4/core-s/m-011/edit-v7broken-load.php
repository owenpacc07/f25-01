...
if (isset($_POST['load'])) {
  //get Standard INPUT data as initial (to textbox)
  $filename1 = "../../../files/submissions/". $mechanismCode ."_". $mid_padded ."_". $user ."/in-".$mid_padded.".dat";
  ...
  //get Standard OUTPUT data as initial (to textbox)
  $filename1 = "../../../files/submissions/". $mechanismCode ."_". $mid_padded ."_". $user ."/out-".$mid_padded.".dat";
  ...
  //get Standard FORMAT data as initial (to textbox)
  $filename1 = "../../../files/submissions/". $mechanismCode ."_". $mid_padded ."_". $user ."/format-".$mid_padded.".txt";
  $fileContent3 = "";
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <textarea class="form-control" name="output" id="output" rows="10"><?php echo htmlentities($fileContent2); ?></textarea>
                </div>
                <div class="col-md-4">
