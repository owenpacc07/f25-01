...
$mid = '022'; // <-- PUT your mechanism ID HERE
$mtitle = '(Your Mechanism Title)';
$_SESSION['mechanismid'] = '022'; //to set the value of mechanism from editData.php
...
$run = "java -classpath /var/www/projects/s23-01/html/cgi-bin/core/m-{$mid} m{$mid}";
...
<body>
    ...
    <div id="bottom-container">
        ...
        <div id="animNavBtns" class="d-flex flex-row justify-content-center">
            <div id="title-content" class="d-flex align-items-center justify-content-center">
                <a class="btn btn-primary" href="/p/s23-01/v3/core-a/m-022/"> Reload Data </a>
            </div>
        ...
        <div id="animNavBtns2" class="d-flex flex-row align-items-center justify-content-center">
            <a class="btn btn-primary" href="/p/s23-01/v3/core-a/editData.php" style="background-color: orange; border-color: orange"> EDIT DATA </a>
