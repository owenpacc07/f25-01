            ...
            <div class="card-content">
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="assignmentName" name="assignmentName" placeholder="Assignment Name">
                    </div>
                    <div class="form-group">
                        <label for="assignmentDescription">Assignment Description</label>
                        <input type="text" class="form-control" id="assignmentDescription" name="assignmentDescription" placeholder="Assignment Description">
                    </div>
                    <div class="form-group">
                        <label for="assignmentDueDate">Assignment Due Date</label>
                        <input type="date" class="form-control" id="assignmentDueDate" name="assignmentDueDate" placeholder="Assignment Due Date">
                    </div>
                    <div class="form-group">
                        <label for="assignmentPoints">Assignment Points</label>
                        <input type="number" class="form-control" id="assignmentPoints" name="assignmentPoints" placeholder="Assignment Points">
                    </div>
