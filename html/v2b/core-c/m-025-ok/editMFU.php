    ...
    if(isset($_POST['submit'])) {
        ...
        if (isset($_POST['viz'])){
            ...
            if (empty($_POST['output'])) {
                ...
                $filename = "/var/www/projects/s23-01/html/files/core-a/m-${mid}/out-${mid}.dat";
        ...
        <div>
            <form action="editMFU.php" method="POST">
                ...
                <div class="field is-grouped">
                    <div class="control">
                        <button class="button is-link" type="submit" name="submit">Submit data</button> 
