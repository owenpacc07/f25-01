...
//Get submission ID and folder, mechanism ID from SESSION variables
//-----------------------------------------------------------------
        ...
        <div class="container">
            <div class="field is-grouped">
                <div class="control" style="width: 100%;">
                    ...
                    <h4 id="description">*Mechanism <?php echo $mid; ?> - Edit Data<?php if ($submissionID) echo " (Submission #$submissionID)"; ?></h4>
