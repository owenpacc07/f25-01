<!-- GENERIC/TEMPLATE CODES for a MECHANISM , please don't delete these m-000 files and folders -->
...
$mID  =$_SESSION['mechanismid'];
    ...
    if(isset($_POST['load'])){
        shell_exec("java -classpath /var/www/projects/f22-02/html/cgi-bin/core/m-000 m000");
        $input = file_get_contents("/var/www/projects/f22-02/html/files/core/m-000/in-000.dat");
        $output = file_get_contents("/var/www/projects/f22-02/html/files/core/m-000/out-000.dat");
    }
...
<html>
    <head>
        ...
        <script type="module" src="javascript/m-001/main.js" defer></script>
    </head>
    <body>
        ...
        <div id="title-content" class="d-flex align-items-center justify-content-center">
            ...
            <h1 id="title">First Come First Serve (Non-Preemptive)</h1>
        </div>
