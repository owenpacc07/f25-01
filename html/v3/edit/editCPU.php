...
<body>
    ...
    <?php 
        ...
        include '../navbar.php';
        $input = file_get_contents("/var/www/projects/f22-02/html/files/p1-cpu-input.txt");
        $fcfs = file_get_contents("/var/www/projects/f22-02/html/files/p1-cpu-output-fcfs.txt");
        $sjf = file_get_contents("/var/www/projects/f22-02/html/files/p1-cpu-output-sjf.txt");
        $sjfp= file_get_contents("/var/www/projects/f22-02/html/files/p1-cpu-output-sjf-p.txt");
        $priority = file_get_contents("/var/www/projects/f22-02/html/files/p1-cpu-output-priority.txt");
        $priorityp = file_get_contents("/var/www/projects/f22-02/html/files/p1-cpu-output-priority-p.txt");
        $roundrobin = file_get_contents("/var/www/projects/f22-02/html/files/p1-cpu-output-roundrobin.txt");
    ?>
