...
JAVA;
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $tmp_dir = "/var/www/projects/f25-01/html/files/submissions/400_4_2/";
        ...
        if (!empty($args) && preg_match('/^\d{3}$/', $args[0])) {
            ...
            if (!in_array($input_filename, $uploaded_files)) {
                ...
                $sample_input_path = "/var/www/projects/f25-01/html/files/submissions/400_4_2/{$input_filename}";
        ...
        if (!empty($job_result['stdout'])) {
            ...
            $output_file = '/var/www/projects/f25-01/html/files/submissions/400_4_2/out-' . $arg_part . '.dat';
