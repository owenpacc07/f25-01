...
<body>
    ...
    <div id="title-content" class="text-center align-items-center justify-content-center secondarycontrols">
        <a style="background-color: orange; border-color: orange" class="btn btn-primary" href="/p/s23-01/v3/core-a/m-004/editData.php"> EDIT Input/Output DATA </a>
        <button style="background-color: orange; border-color: orange" type="button" class="btn btn-primary" id="run" name="run" onclick="location.reload();">Run</button>
        <button style="background-color: orange; border-color: orange" type="button" class="btn btn-primary" id="viz" name="viz" onclick="location.reload();">Visualize</button>
