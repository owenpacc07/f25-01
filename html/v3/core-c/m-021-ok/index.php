...
$_SESSION['mechanismid'] = '021'; //to set the value of mechanism from editData.php
...
$compile = "javac /var/www/projects/s23-01/html/cgi-bin/core/m-$mid/$mid.java";
$run = "java -classpath /var/www/projects/s23-01/html/cgi-bin/core/m-$mid m$mi}";
shell_exec("java -classpath /var/www/projects/s23-01/html/cgi-bin/core/m-$mid m$mid"); //change to current
shell_exec($compile);
shell_exec($run);
?>
...
<body>
    ...
    <div id="bottom-container">
        <div id="title-content" class="d-flex align-items-left justify-content-left">
           &nbsp;  <a class="btn btn-primary" href="/p/s23-01/v3/core-a/"> Back </a>
        </div>
    </div>
    ...
    <div id="animNavBtns" class="d-flex flex-row justify-content-center">
        <div id="title-content" class="d-flex align-items-center justify-content-center">
            <a class="btn btn-primary" href="/p/s23-01/v3/core-a/m-021/"> Reload Data </a>
        </div>
    ...
    <div id="animNavBtns2" class="d-flex flex-row align-items-center justify-content-center text-light ">
        <a class="btn btn-primary" style="background-color: orange; border-color: orange;  ">EDIT DATA </a>
&nbsp;
        <button type="button" class="btn btn-primary" id="Vizualize">Vizualize</button>
        &nbsp; 
