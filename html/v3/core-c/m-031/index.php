...
//$javaCommand = "java -classpath /var/www/p/s25-01/html/cgi-bin/core-c/m-031 m031 " . escapeshellarg($path);
$javaCommand = "java -classpath " . realpath(__DIR__ . "/../../cgi-bin/core-c/m-031") . " m031 " . escapeshellarg($path);
