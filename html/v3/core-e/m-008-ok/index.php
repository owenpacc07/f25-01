...
<body>
    ...
    <div class="container">
      ...
      <!-- Buttons for changing data and reloading page for -a mode -->
    <div id="title-content" class="text-center align-items-center justify-content-center">
        <a style="background-color: orange; border-color: orange" class="btn btn-primary" onclick="location.href='../../index-a.php';"> Exit </a>
        <a style="background-color: orange; border-color: orange" class="btn btn-primary" href="/p/s24-02/v2/core-a/m-008/edit.php"> Edit Data </a>
        <button style="background-color: orange; border-color: orange" type="button" class="btn btn-primary" id="refreshPage" onclick="location.reload();">Run</button>
        <button style="background-color: orange; border-color: orange" type="button" class="btn btn-primary" id="refreshPage" onclick="location.reload();">Visualize</button>
        <button style="background-color: orange; border-color: orange" type="button" class="btn btn-primary" id="refreshPage" onclick="location.reload();">Reload</button>
    </div>
    ...
    <div id="animNavBtns2" class="text-center align-items-center justify-content-center" style="margin-bottom: 25px">
