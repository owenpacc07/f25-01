...
$mid = '023'; // <-- PUT your mechanism ID HERE
...
<body>
    ...
    <div id="animNavBtns" class="d-flex flex-row justify-content-center">
        <button type="button" class="btn btn-primary" id="refresh" onclick="location.reload(true)">Refresh Data</button> <button type="button" class="btn btn-primary" id="skipBack">Reset</button>
    ...
    <div id="inputdiv" style="margin-top: 1em;" class="d-flex flex-row justify-content-center">
        <a class="btn btn-primary" href="./editLRU.php" style="background-color: orange; border-color: orange"> EDIT Input/Output DATA </a>
        <a class="btn btn-primary" href="./editlFU.php" style="background-color: orange; border-color: orange"> Vizualize </a>
        <a class="btn btn-primary" href="./editlFU.php" style="background-color: orange; border-color: orange"> Run </a>
    </div>
