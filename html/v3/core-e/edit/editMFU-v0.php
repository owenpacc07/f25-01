<?php
    ...
    if(isset($_POST['submit'])) {
        // validate input
        $input = $_POST['input'];
        if (!preg_match('/^[0-9,]*$/', $input)) {//Only allow numbers seperated  by commas
            echo "<script>alert('Invalid input. Only numbers separated by commas are allowed.')</script>";
            exit();
        }

        // Sanitize and validate output
        $output_mfu = $_POST['output-mfu'];
        $output_format = $_POST['output-format'];
        if (preg_match('/<\s*script/i', $output_mfu) || preg_match('/<\s*script/i', $output_format)) {
         ...
         file_put_contents("/var/www/projects/s23-01/html/files/core-a/m-023/in-023.dat", $input);
         file_put_contents($filename, $input);
        ...
        // do same for output
         ...
         header('Location: ../m-025/index.php');
        exit();
    }
    ...
    $filename = "/var/www/projects/s23-01/html/files/core-a/m-025/out-025.dat";
...
<body>
    ...
    <div class="section" style="display: inline;" >
        <div>
            <form action="editMFU.php" method="POST">
                <div class="columns">
                    ...
                    <div class="field column" style="max-width: 500px;">
                        ...
                        <textarea readonly name="output-mfu" id="output-mfu" cols="10" rows="10" class="textarea"><?php echo htmlentities($original_output); ?></textarea>
                    </div>
                    <div class="field column" style="max-width: 500px;">
                ...
                <div class="field is-grouped">
                    <div class="control">
                        ...
                        <a class="button is-link is-light" href="../m-025/index.php'">Cancel</a> 
                    </div>
                </div>
            </form> 
        </div>
