...
<body>
    ...
    <div id="title-content" class="text-center align-items-center justify-content-center secondarycontrols">
        <a style="background-color: orange; border-color: orange" class="btn btn-primary" href="/p/s23-01/v3/core-a/m-006/editData.php"> EDIT Input/Output DATA </a>
