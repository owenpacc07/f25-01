...
async function runProgram() {
  inputValues = await readTextFile("input");
  outputValues = await readTextFile("output");

  console.log("head:", head);
  console.log("DEBUG main.js - inputValues (parsed):", inputValues);
  console.log("DEBUG main.js - outputValues (parsed):", outputValues);
 /*
 ...
 */
  ...
  console.log("DOM update:", inputValues, outputValues);
