...
$rfile = fopen("e11codeParts.txt", "r");
while(!feof($rfile))
  {
    $line = fgets($rfile);
    //echo $line . "<br>";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["cvalue3"])) {
    $valueErr = "Value is required";
  } else {
    $cvalue3  = test_input($_POST["cvalue3"]);    
  }
  if (empty($_POST["cvalue4"])) {
    $valueErr = "Value is required";
  } else {
    $cvalue4  = test_input($_POST["cvalue4"]);    
  }
...
<form method="post" action="e11uProcess.php">  
  ...
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
   Element ID: <input type="text" name="id3" value="<?php echo htmlentities($arri[25]); ?>">
  <span class="error">* <?php echo $nameErr;?></span>
  <br><br>
   CheckBox Value3: <input type="text" name="cvalue3" value="<?php echo htmlentities($arri[29]); ?>">
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
   CheckBox Label 3: <input type="text" name="lvalue3" value="<?php echo htmlentities($arri[33]); ?>">
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
  Element ID: <input type="text" name="id4" value="<?php echo htmlentities($arri[35]); ?>">
  <span class="error">* <?php echo $nameErr;?></span>
  <br><br>
   CheckBox Value4: <input type="text" name="cvalue4" value="<?php echo htmlentities($arri[39]); ?>">
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
   CheckBox Label 4: <input type="text" name="lvalue4" value="<?php echo htmlentities($arri[43]); ?>">
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
