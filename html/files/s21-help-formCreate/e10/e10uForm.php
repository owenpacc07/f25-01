...
$rfile = fopen("e10codeParts.txt", "r");
while(!feof($rfile))
  {
    $line = fgets($rfile);
    //echo $line . "<br>";
...
<form method="post" action="e10uProcess.php">  
  ...
  <span class="error">* <?php echo $nameErr;?></span>
  <br><br>
   Radio Value3: <input type="text" name="rvalue3" value="<?php echo htmlentities($arri[29]); ?>">
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
   Radio Label 3: <input type="text" name="lvalue3" value="<?php echo htmlentities($arri[33]); ?>">
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
  Element ID: <input type="text" name="id4" value="<?php echo htmlentities($arri[35]); ?>">
  <span class="error">* <?php echo $nameErr;?></span>
  <br><br>
   Radio Value3: <input type="text" name="rvalue4" value="<?php echo htmlentities($arri[39]); ?>">
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
   Radio Label 3: <input type="text" name="lvalue4" value="<?php echo htmlentities($arri[43]); ?>">
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
