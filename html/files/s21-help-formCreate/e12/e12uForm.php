...
$rfile = fopen("e12codeParts.txt", "r");
while(!feof($rfile))
  {
    $line = fgets($rfile);
    //echo $line . "<br>";
...
<form method="post" action="e12uProcess.php">  
  ...
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
  SELECT Value 3: <input type="text" name="svalue3" value="<?php echo htmlentities($arri[17]); ?>">
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
  Label Value 3: <input type="text" name="lvalue3" value="<?php echo htmlentities($arri[19]); ?>">
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
  SELECT Value 4: <input type="text" name="svalue4" value="<?php echo htmlentities($arri[21]); ?>">
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
  Label Value 4: <input type="text" name="lvalue4" value="<?php echo htmlentities($arri[23]); ?>">
  <span class="error">* <?php echo $valueErr;?></span>
  <br><br>
