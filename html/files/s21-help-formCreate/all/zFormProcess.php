...
$rvalue1 = $rvalue2 = $lvalue = $lvalue1 = $lvalue2 = $labelName = $rname = $rvalue1 = $rvalue2 = $r = $wbody = $line = $block = "";

// READ generic code in file
$rfile = fopen("gen.txt", "r");
while(!feof($rfile))
  {
    $line = fgets($rfile);
    //echo $line . "<br>";
...
$wfile = fopen("code.htm", 'w');
  fwrite($wfile, $block);
fclose($wfile);

// WRITE PARTS of HTML code to file
$wfile = fopen("codeParts.txt", 'w');
  fwrite($wfile, $ablock);
fclose($wfile);
