...
public class Main {
	...
	public static void main(String args[]) throws IOException {
		String inputFile;
		if (args.length == 0) {
			System.out.println("No arguments given, using default input file");
			inputFile = "in-1.dat"; // Fixed: use current directory
		} else {
	...
	public static void outFile() throws IOException {
		File outFile = new File("out-1.dat"); // Fixed: use current directory
	...
	static void updateFlagFile() {
		try {
			...
			File flagFile = new File("flag-file.txt"); // Fixed: use current directory
