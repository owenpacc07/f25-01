  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container-fluid">
      <a class="navbar-brand" href="https://cs.newpaltz.edu/p/f22-02/v2">
        <img src="/p/f22-02/files/favicon.ico" alt="" width="30" height="24" class="d-inline-block align-text-top">
        OS Visualizations
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link " aria-current="page" href="https://cs.newpaltz.edu/p/f22-02/v2/1-cpu/index.php">CPU Scheduling</a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="https://cs.newpaltz.edu/p/f22-02/v2/6-address/index.php">Address Translation</a>
          </li>
          <li class="nav-item   ">
            <a class="nav-link" href="https://cs.newpaltz.edu/p/f22-02/v2/4-memory-allocation/index.php">Memory Allocation</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://cs.newpaltz.edu/p/f22-02/v2/2-replace/index.php">Page Replacement</a>
          </li>
          <li class="nav-item">
            <a href="https://cs.newpaltz.edu/p/f22-02/v2/5-files/index.php" class="nav-link">File Allocation</a>
          </li>
          <li class="nav-item">
            <a href="https://cs.newpaltz.edu/p/f22-02/v2/3-disk/index.php" class="nav-link">Disk Scheduling</a>
          </li>
          <li class="nav-item">
            <a href="https://cs.newpaltz.edu/p/f22-02/v2/coding.php" class="nav-link">Coding</a>
          </li>
        </ul>
        <ul class="navbar-nav ms-auto mb-2">

          <?php if (!isset($_SESSION['logged_in'])) {
            echo "<a role='button' class='btn btn-primary' href='https://cs.newpaltz.edu/p/f22-02/v2/register.php'>
