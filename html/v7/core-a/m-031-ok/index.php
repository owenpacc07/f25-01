...
// passes the path of the input and output files to the java code
$filespath = realpath("../../../files/core-a/m-{$mid}");
shell_exec("java -classpath $path m{$mid} $filespath");

//echo "java -classpath $path m{$mid} $filespath";
?>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center">
        <input class="btn btn-primary" type="button" value="Reload Data" id="reload" onclick="location.reload();">
        <input class="btn btn-primary" type="button" value="Reset" id="reset">
        <input class="btn btn-primary" type="button" value="< Step" id="back">
        <input class="btn btn-primary" type="button" value="Play" id="play">
        <input class="btn btn-primary" type="button" value="Step >" id="next">
        <input class="btn btn-primary" type="button" value="End" id="end">
    </div>
