...
function fcfsClick(e) {
    ...
    // location.replace("https://cs.newpaltz.edu/p/f22-02/v2/p3-os-main/core/m-001.php");
...
function sjfClick(e) {
    ...
    // location.replace("https://cs.newpaltz.edu/p/f22-02/v2/p3-os-main/core/m-002.php");
...
function prioHighClick(e) {
    ...
    // location.replace("https://cs.newpaltz.edu/p/f22-02/v2/p3-os-main/core/m-003.php");
...
function prioLowClick(e) {
    ...
    location.replace("https://cs.newpaltz.edu/p/f22-02/v2/p3-os-main/core/m-004.php");
...
function rrClick(e) {
    ...
    location.replace("https://cs.newpaltz.edu/p/f22-02/v2/p3-os-main/core/m-005.php");
