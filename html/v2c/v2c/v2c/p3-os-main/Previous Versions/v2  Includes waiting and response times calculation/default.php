<?php
    ...
    $defaultIn = fopen("../../files/p3/p1-cpu-input.txt", "w") or die("Unable to open file!");
    ...
    //FCFS
    $defaultFCFS = fopen("../../files/p3/p1-cpu-output-fcfs.txt","w") or die("Unable to open file!");
    ...
    //SJF:NON
    $defaultSJFnon = fopen("../../files/p3/p1-cpu-output-sjf.txt","w") or die("Unable to open file!");
    ...
    $defaultSJFpre = fopen("../../files/p3/p1-cpu-output-sjf-p.txt", "w") or die("Unable to open file!");
    ...
    //PRIO:NON
    $defaultPRIOnon = fopen("../../files/p3/p1-cpu-output-priority.txt","w") or die("Unable to open file!");
    ...
    //PRIO:PRE
    $defaultPRIOpre = fopen("../../files/p3/p1-cpu-output-priority-p.txt","w") or die("Unable to open file!");
    ...
    //RR
    $defaultRR = fopen("../../files/p3/p1-cpu-output-roundrobin.txt", "w") or die("Unable to open file!");
