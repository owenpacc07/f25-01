...
export async function loadData() {
    ...
    const IOResponse = await fetchIO(compare, mid);
    if (IOResponse.error){
...
function parseOutputDataFile(text) {
    ...
    // deconstruction of the outputfile array into an array of arrays by Extract the first character and split the rest of the input on newline
