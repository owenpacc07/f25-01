...
let output = [{pid: 1, start: 0, end: 1, burst: 1}, 
            {pid: 2, start: 1, end: 3, burst: 2}, 
            {pid: 4, start: 3, end: 7, burst: 4}, 
            {pid: 3, start: 7, end: 12, burst: 5}, 
            {pid: 1, start: 12, end: 17, burst: 5}];
...
function nextAnim() {
    ...
    let waitTime = completionTime - arrivalTime - burstTime;
    ...
    } // add response time to array for average calculation
