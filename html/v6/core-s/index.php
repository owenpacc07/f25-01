...
session_start();
        ...
        //$baseDirectory = '/var/www/projects/f25-01/html/files/submissions/';
        //$prefix = "/var/www/p/f25-01/html"; // Specified in "../../system.php"

        $baseDirectory = $prefix . '/files/submissions/';
...
if (isset($_POST['deleteSubmissionID'])) {
    ...
    if ($fetchResult && mysqli_num_rows($fetchResult) > 0) {
        ...
        // Specify the base directory = see TOP of the page
        //$baseDirectory = '/var/www/projects/f25-01/html/files/submissions/';
...
$mechanism_code = $_POST['algorithm-options'];
$mid_padded = str_pad($mechanism_code, 3, '0', STR_PAD_LEFT);
$mechanism_id = $mechanism_code;
        ...
        // Log to console
        $_SESSION['log_messages'][] = "DEBUG: Creating NEW submission - MID: $mid, MID_PADDED: $mid_padded, USER: $user, SESSION_KEY: $session_key, mechCode: $mechanism_code ";
...
/*
$folderName = $submission_id . "_" . $mechanism_code . "_" . $user;
$restrict_view = 1;
$input_path = $submissions_base . "/". $folderName;
$output_path = $input_path;
$code_path = $input_path;
*/

$_SESSION['log_messages'][] = "DEBUG: submissions_base: $submissions_base, subFolder: $folderName, Full path: $input_path";
...
$_SESSION['mechanismTitle'] = $mtitle;
$_SESSION['mechanismCode'] = $mechanism_code;
                        ...
                        // Loop through the submissions data
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><button class='btn btn-info' data-toggle='modal' data-target='#<?php echo $modal_id ?>'>OPEN</button></td>
