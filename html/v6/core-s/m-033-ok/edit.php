...
$mid = '033';
$path = realpath("../../../files/core-a/m-$mid");
        ...
        <div class="container">
            <div class="row">
                <div class="field is-grouped">
                    <div class="control">
                        <h4 id="description">033 Edit Data</h4>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <textarea readonly class="form-control" name="output" id="output" rows="10"><?php echo htmlentities($output); ?></textarea>
                </div>
                <div class="col-md-4">
                    <label for="textarea2">Format:</label>
                    <textarea readonly class="form-control" name="output" id="format" rows="10"><?php echo htmlentities($format); ?></textarea>
                </div>
                <div class="field is-grouped">
                    <div class="control">
