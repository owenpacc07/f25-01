        ...
        <div class="container">
            ...
            <div class="field is-grouped">
                <div class="control button-group">
                    ...
                    <button class="btn btn-primary" type="submit" name="submit" value="proceed">View I/O</button>
                    <button class="btn btn-primary" type="submit" name="submit" value="proceed">Full View</button>
