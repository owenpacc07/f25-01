import { readTextFile, head, inputData, outputData, checkFlag, resetFlagFile} from './load_data.js';
...
run.onclick = function(){displayLine("run",null)};
...
btnStart.addEventListener("click", function() {
    ...
    if (btnStart.innerHTML.trim() === "Play") {
        ...
        visualize.innerHTML = "Visualizing";
    }
...
visualize.addEventListener("click", function() {
    if (visualize.innerHTML.trim() === "Visualize") {
        console.log("Equals play");
        displayLine("play",intervalID);
        btnStart.innerHTML = "Pause";
        visualize.innerHTML = "Visualizing";
    }
    else if (visualize.innerHTML.trim() === "Visualizing") {
        console.log("Equals pause");
        displayLine("pause",intervalID);
        btnStart.innerHTML = "Play";
        visualize.innerHTML = "Visualize";
...
async function runProgram() {
    //loops 50 times waiting for flag file, if nothing then output text file data is loaded
    var i = 0;
    while (!flagFile) {
        flagFile = await checkFlag();
