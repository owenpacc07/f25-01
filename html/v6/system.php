...
//java SAMPLE code for SUBMISSION location
$sampleDir = $ROOT_DIR . "/files/core-s/sc";
...
//java code SUB location
$cgibin_core_s = $ROOT_DIR . "/cgi-bin/core-s";
//$cgibin_core_s = $prefix . "/cgi-bin/core-s";
