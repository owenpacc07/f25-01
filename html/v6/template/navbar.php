        ...
        <a class="navbar-brand logodimension" href="#"><img src="https://cs.newpaltz.edu/p/<?= $semester ?><?= $version_path ?>/pic/logocircle02.png" alt="" class="d-inline-block align-text-top"> WebViz OS</a>
          ...
          <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
            <div class="offcanvas-header">
              ...
              <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas" aria-label="Close" href="./index.php"></button>
            </div>
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="./core">Select Mechanism</a>
                </li>
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-dark">
                    ...
                    <li><a class="dropdown-item" href='./register.php'>No registered? Sign up here.</a></li>
                  </ul>
                </li>
              </ul>
