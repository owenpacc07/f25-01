...
let input_file_path = 'https://cs.newpaltz.edu/p/f22-02/files/core/m-006/in-006.dat';
let output_file_path = 'https://cs.newpaltz.edu/p/f22-02/files/core/m-006/out-006.dat';
...
function fetchPHP(type) {
    ...
    fetch('https://cs.newpaltz.edu/p/f22-02/v2/p3-os-main/core/php/m-006/manage-flag-file-006.php', {
        method: 'POST',
        headers: {
