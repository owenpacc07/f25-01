...
<div class="d-flex align-items-center justify-content-center">
    ...
    <div class="d-flex align-items-center justify-content-center">
        <button class="button is-link"  onclick="start()">Start </button>
        ...
        <button class="button is-link" id= "pause">Pause</button>
        <button class="button is-link" id= "end">End</button>
        <button class="button is-link" id= "edit" onclick="editTable()">Edit Text</button>
...
<div id="body">
   ...
   <script>
    ...
    function editTable(){
            location.replace("../edit/editIoCycle.php")
        }
...
/*   document.getElementsByTagName('button')[0].addEventListener('click', function() {
    ...
    function step2() {
       // setTimeout(() => {
            $("#arrow1").hide();
            $("#arrow2").show();
            document.getElementById("system-call-box").innerHTML = "System Call:" + "  " +  "I/O Request";
    ...
    function step7() {
       // setTimeout(() => {
            ...
            document.getElementById('monitor-box-done').style.cssText = 'background-color: red';
    ...
    function step8() {
       // setTimeout(() => {
            ...
            document.getElementById('monitor-box-done').style.cssText = 'background-color: white';
