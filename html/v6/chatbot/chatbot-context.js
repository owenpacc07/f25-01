...
export function getChatbotContext() {
  const context = {
    ...
    mechanismName: getMechanismName(extractMechanismId()),
    category: detectMechanismCategory(extractMechanismId()),
...
/**
 * Get enhanced context with mechanism metadata
 *
 * @returns {object} Full context with algorithm information
 */
