        ...
        <div id="menuCol" class="column is-one-fifth">
            <div class="container  rounded-end" id="menuContainer">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item"><a class="menu-link" id="dashboard" onclick="toggle_panel('dashboard')">
                    ...
                    <li class="nav-item"><a class="menu-link" style="color: inherit; text-decoration: none;"
...
<script>
    function toggle_panel(showPanel) {
        ...
        switch (showPanel) {
            case 'fileViewer':
                window.location.href = "https://cs.newpaltz.edu/p/s23-01/v2/adminPanel/fileViewer.php";
                break;
            case 'manage-users':
