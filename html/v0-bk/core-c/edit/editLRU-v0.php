...
require_once '../tempfunctions.php';
      ...
      if(isset($_POST['submit'])) {
        ...
        $output_lru = $_POST['output-mfu'];
        $output_format = $_POST['output-format'];
        if (preg_match('/<\s*script/i', $output_lru) || preg_match('/<\s*script/i', $output_format)) {
       ...
       // do same for output
        $filename = get_temp_file_path($httpcore_a_IO."/m-${mid}/out-${mid}.dat");
        ...
        header('Location: ../m-023/index.php');
        exit();
    }
            ...
            <form action="editLRU.php" method="POST">
                ...
                <div class="field is-grouped">
                    <div class="control">
                        ...
                        <a class="button is-link is-light" href="../m-023/index.php'">Cancel</a> 
                    </div>
                </div>
            </form> 
        </div>
