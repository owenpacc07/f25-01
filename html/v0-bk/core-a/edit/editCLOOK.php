...
<body>
    ...
    <?php 
        ...
        $outputcscan = file_get_contents("/var/www/projects/f21-13/html/files/p6-disk-output-cscan.txt");
        $outputfcfs = file_get_contents("/var/www/projects/f21-13/html/files/p6-disk-output-fcfs.txt");
        $input = file_get_contents("/var/www/projects/f21-13/html/files/p6-disk-input.txt"); ?>
