...
if (isset($_POST['load'])) {
    shell_exec("java -classpath /var/www/projects/f22-02/html/cgi-bin/core/m-001 Scheduler");
    $input = file_get_contents("/var/www/projects/f22-02/html/files/core/m-001/in-001.dat");
    $output = file_get_contents("/var/www/projects/f22-02/html/files/core/m-001/out-001.dat");
}
