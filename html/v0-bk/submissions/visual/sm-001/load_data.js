...
const userInputFilePath = inputFile.split('/').slice(6, 10).join('/'); // get user folder path

// Input and output file paths
const input_file_path = `https://cs.newpaltz.edu/p/s23-01/${userInputFilePath}`;
const output_file_path = `https://cs.newpaltz.edu/p/s23-01/files/core-a/m-${mid}/out-${mid}.dat`;
...
async function fetchPHP(type) {
    await fetch(`https://cs.newpaltz.edu/p/s23-01/v3/core-a/m-${mid}/manage-flag-file.php`, {
        method: 'POST',
        headers: {
