...
let responseTimes = [];
let schedulingMethod = "prioLow";
let animationPlaying = false;

// address to the other CPU Scheduling pages
let first_come_first_serve = 'https://cs.newpaltz.edu/p/f22-02/v2/p3-os-main/core/index.php?page=m-001';
let shortest_job_first = 'https://cs.newpaltz.edu/p/f22-02/v2/p3-os-main/core/index.php?page=m-002';
let priority_high_to_low = 'https://cs.newpaltz.edu/p/f22-02/v2/p3-os-main/core/index.php?page=m-003';
let priority_low_to_high = 'https://cs.newpaltz.edu/p/f22-02/v2/p3-os-main/core/index.php?page=m-004';
let round_robin = 'https://cs.newpaltz.edu/p/f22-02/v2/p3-os-main/core/index.php?page=m-005';

// Input and output file paths
let input_file_path = 'https://cs.newpaltz.edu/p/f22-02/files/core/m-002/in-002.dat';
let output_file_path = 'https://cs.newpaltz.edu/p/f22-02/files/core/m-002/out-002.dat';
...
function redirectToHome(e) {
    location.replace('https://cs.newpaltz.edu/p/f22-02/v2/p3-os-main/core/');
}
    ...
    if (proc === -1) {
        ...
        for (let i = 0; i < otherOutputInformation.length; i++) {
            ...
            if (currentWaitTag != null) {
                ...
                currentProcessIdIndex = sorted[i][0] - 1;
        ...
        for (let i = 0; i < proc + 1; i++) {
            ...
            if (currentWaitTag != null) {
                ...
                currentProcessIdIndex = sorted[i][0] - 1;
                console.log(currentProcessIdIndex);
                burstTime = procHandler[currentProcessIdIndex][2];
