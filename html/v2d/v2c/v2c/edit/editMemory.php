...
<body>
    ...
    <?php 
        ...
        include '../navbar.php';
        $outputfirstfit = file_get_contents("/var/www/projects/f22-02/html/files/p3-memory-output-firstfit.txt");
        $outputbestfit = file_get_contents("/var/www/projects/f22-02/html/files/p3-memory-output-bestfit.txt");
        $outputworstfit = file_get_contents("/var/www/projects/f22-02/html/files/p3-memory-output-worstfit.txt");
        $input = file_get_contents("/var/www/projects/f22-02/html/files/p3-memory-input.txt"); ?>
