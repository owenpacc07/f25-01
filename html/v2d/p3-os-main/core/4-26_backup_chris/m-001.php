...
<html>
    <head>
        ...
        <!-- <script type="module" src="javascript/m-001/loading_data_backend.js" defer></script> -->
    </head>
    <body>
                ...
                <div class="selection">
                    ...
                    <div class="radio-buttons selection-spacing">
                        ...
                        <form id="preType" class="vertical-flex">
                            <input type="radio" id="non-preemptive" name="preType" value="nonpre" checked disabled>
                            <label for="non-preemptive">Non-Preemptive</label>
                            <br>
                            <input type="radio" id="preemptive" name="preType" value="pre" disabled>
