...
public class m004 {
	...
	static void updateFlagFile() {
		try {
			...
			File flagFile = new File("../../../files/core/m-004/flag-file.txt");
	...
	public static void inFile() throws FileNotFoundException // Good
	{
		...
		File inFile = new File("../../../files/core/m-004/in-004.dat");
	...
	public static void outFile() throws IOException {
		File outFile = new File("../../../files/core/m-004/out-004.dat");
