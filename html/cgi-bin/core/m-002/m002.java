...
public class m002 {
	...
	static void updateFlagFile() throws IOException {
		...
		File flagFile = new File("../../../files/core/m-002/flag-file.txt");
		// File flagFile = new
	...
	public static void inFile() throws FileNotFoundException // Good
	{
		try {
			...
			File inFile = new File("../../../files/core/m-002/in-002.dat");
	...
	public static void outFile() throws IOException {
		File outputFile = new File("../../../files/core/m-002/out-002.dat");
		try {
