...
public class m003 {
	...
	static void updateFlagFile() {
		try {
			File flagFile = new File("../../../files/core-a/m-003/flag-file.txt");
			FileWriter writer = new FileWriter(flagFile, false);
			writer.write("1");
			System.out.println("Flag file updated");
			writer.close();
	...
	public static void inFile() throws FileNotFoundException // Good
	{
		...
		File inFile = new File("../../../files/core-a/m-003/in-003.dat");
		Scanner in = new Scanner(inFile);

		int pID, pArrive, pBurst, pPriority, i = 0;
		String line;

		// Priority High -> Low scheduler type
		line = "2";
	...
	public static void outFile() throws IOException {
		File outFile = new File("../../../files/core-a/m-003/out-003.dat");
