...
public class m003 {
	...
	static void updateFlagFile() {
		try {
			File flagFile = new File("../../../files/core-c/m-003/flag-file.txt");
	...
	public static void inFile() throws FileNotFoundException // Good
	{
		...
		File inFile = new File("../../../files/core/m-003/in-003.dat");
	...
	public static void outFile() throws IOException {
		File outFile = new File("../../../files/core-c/m-003/out-003.dat");
