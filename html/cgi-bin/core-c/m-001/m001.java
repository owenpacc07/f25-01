...
public class m001 {
	...
	static void updateFlagFile() {
        try {
            File flagFile = new File("/var/www/projects/s25-01/html/files/core-c/m-001/flag-file.txt"); // Absolute path
	...
	public static void main(String args[]) throws IOException {
		String inputFile;
		if (args.length == 0) {
			System.out.println("No arguments given, usiung default values");
			inputFile = "/var/www/projects/s25-01/html/files/core-c/c-cpu/in-cpu.dat";
		} else {
	...
	public static void outFile() throws IOException {
		File outFile = new File("/var/www/projects/s25-01/html/files/core-c/m-001/out-001.dat");
