...
public class m007 {
  ...
  static void updateFlagFile() {
    try {
      File flagFile = new File(
          "../../../files/core-c/m-007/flag-file.txt");
  ...
  public static void inFile() throws FileNotFoundException {
    ...
    // Priority High -> Low (preemptive) scheduler type
    line = "6"; // Hardcoded for m007
    buffer.append(line.charAt(i)); // scheduler type
    typeScheduler = Integer.parseInt(buffer.toString());
    buffer.setLength(0);

    // No quantum parsing needed for type 6 (pPH), skip RR block
    ...
    while (in.hasNextLine()) {
        ...
        // Process Priority------------------------//
        while (i < line.length()) { // No '/' in your input, go to end
            buffer.append(line.charAt(i));
            i++;
        }
  ...
  public static void outFile() throws IOException {
    File outFile = new File(
        "../../../files/core-c/m-007/out-007.dat");
